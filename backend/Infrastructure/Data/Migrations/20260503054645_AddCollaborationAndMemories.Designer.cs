...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260503054645_AddCollaborationAndMemories")]
    partial class AddCollaborationAndMemories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.LocalInfoNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LocalInfoNotes");
                });

            modelBuilder.Entity("Domain.Entities.MemoryPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.MemoryTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.MemoryTagMapping", b =>
                {
                    ...
                    b.ToTable("MemoryTagMappings");
                });

            modelBuilder.Entity("Domain.Entities.PackingItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.PackingList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.TravelChecklist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TravelChecklists");
                });

            modelBuilder.Entity("Domain.Entities.TravelDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.TripTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.ChecklistItem", b =>
                {
                    b.HasOne("Domain.Entities.TravelChecklist", "Checklist")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.MemoryTagMapping", b =>
                {
                    b.HasOne("Domain.Entities.MemoryPhoto", "Photo")
                        .WithMany("Tags")
                        .HasForeignKey("PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.MemoryTag", "Tag")
                        .WithMany("Photos")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PackingItem", b =>
                {
                    b.HasOne("Domain.Entities.PackingList", "PackingList")
                        .WithMany("Items")
